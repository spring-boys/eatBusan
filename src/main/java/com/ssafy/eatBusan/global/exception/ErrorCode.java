...
public enum ErrorCode {
    ...
    // comment
    COMMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "없는 댓글입니다."),
    COMMENT_CONTENT_EMPTY(HttpStatus.BAD_REQUEST, "댓글의 본문은 공백이 될 수 없습니다."),
    INVALID_PAGE_SIZE(HttpStatus.BAD_REQUEST, "페이지 사이즈는 0보다 커야 합니다.");
